...
class sugoi_form_elements_DateDropdowns extends sugoi_form_FormElement {
	public function __construct($name, $label, $_value = null, $required = null, $yearMin = null, $yearMax = null, $validators = null, $attibutes = null) {
		...
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::new");
	...
	public function shortLabels() {
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::shortLabels");
		$__hx__spos = $GLOBALS['%s']->length;
	...
	public function init() {
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::init");
		$__hx__spos = $GLOBALS['%s']->length;
		parent::init();
	...
	public function populate() {
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::populate");
		$__hx__spos = $GLOBALS['%s']->length;
	...
	public function isValid() {
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::isValid");
		$__hx__spos = $GLOBALS['%s']->length;
		{
			$GLOBALS['%s']->pop();
			return true;
	...
	public function render() {
		$GLOBALS['%s']->push("sugoi.form.elements.DateDropdowns::render");
		$__hx__spos = $GLOBALS['%s']->length;
		parent::render();
		...
		{
			$tmp = "<div class=\"row\">\x0D\x0A\x09\x09  <div class=\"col-xs-2\">" . _hx_string_or_null($this->daySelector->render()) . "</div>\x0D\x0A\x09\x09  <div class=\"col-xs-6\">" . _hx_string_or_null($this->monthSelector->render()) . "</div>\x0D\x0A\x09\x09  <div class=\"col-xs-4\">" . _hx_string_or_null($this->yearSelector->render()) . "</div>\x0D\x0A\x09\x09</div>";
			$GLOBALS['%s']->pop();
			return $tmp;
		}
		$GLOBALS['%s']->pop();
